...
|---------------------|---------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| CLIENT_SECRET_BASIC | clientSecretEnvVarName   | client_secret is specified through environment variable, the environment variable name is the same as the value of clientSecretEnvVarName                                                                                                            |
| CLIENT_SECRET_POST  | clientSecretEnvVarName   | same as CLIENT_SECRET_BASIC                                                                                                                                                                                                                          |
| CLIENT_SECRET_JWT   | clientSecretEnvVarName   | same as CLIENT_SECRET_BASIC                                                                                                                                                                                                                                             |
